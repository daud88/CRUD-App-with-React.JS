...
export function Products() {
  ...
  function showForm(product) {
    setContent(<ProductFormView product={product} showList={showList} />);
  }
...
function ProductList(props) {
  ...
  return (
    <>
      <h2 className="text-center mb-3">Lists of Products</h2>
      <button
...
function ProductForm(props) {
  const { products, showForm, deleteProduct } = props;
